...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        ...
        patches from TWRP Gerrit instance (or any gerrit instance of your choosing)
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit pb', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch pb', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
